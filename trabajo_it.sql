...
-- Tiempo de generación: 02-06-2024 a las 18:32:04
...
(1, 'Reclutamiento', '20492978R', 'Equipo responsable de encontrar, atraer a candidatos para ocupar los puestos vacantes dentro de la organización.');
...
('20492978R', 'Juan Vicente', 'Casado Salas', 'Barrio Nueva, 28, 49201, Molezuelas De La Carballeda(zamora)', 'Jefe', 1, NULL, 'JuanVicenteCasado'),
('76422695C', 'Julia', 'Perea Marquez', 'Rambla De España, 49, 17035, Peralada(Girona)', 'Empleada', 1, NULL, 'JuliaPerea');
